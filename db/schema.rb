...
ActiveRecord::Schema.define(version: 20_200_325_140_711) do
  ...
  create_table 'collectible_attributes', force: :cascade do |t|
    ...
    t.index %w[collectible_attribute_value_type collectible_attribute_value_id], name: 'collectible_attribute_value_index'
  ...
  create_table 'locations', force: :cascade do |t|
    ...
    t.index %w[location_value_type location_value_id], name: 'location_value_index'
  end

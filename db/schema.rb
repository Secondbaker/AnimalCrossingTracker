...
ActiveRecord::Schema.define(version: 2020_05_01_144350) do
  ...
  create_table "collectible_filters", force: :cascade do |t|
    t.string "name"
    t.string "keyword"
  ...
  create_table "collectible_sorts", force: :cascade do |t|
    t.string "name"
    t.string "keyword"
    t.string "collectible_attribute_class_name"
    t.datetime "created_at", precision: 6, null: false

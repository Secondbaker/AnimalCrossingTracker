...
class TimeOfYearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_of_year" do
    assert_difference('TimeOfYear.count') do
      post time_of_years_url, params: { time_of_year: { end: @time_of_year.end, start: @time_of_year.start } }
    end
  ...
  test "should update time_of_year" do
    patch time_of_year_url(@time_of_year), params: { time_of_year: { end: @time_of_year.end, start: @time_of_year.start } }
